...
test(union_1) :- union([], [], []).
test(union_2) :- union([1], [], [1]).
test(union_3) :- union([], [1], [1]).
test(union_4) :- union([1, 2], [2, 3], [1, 2, 3]).
test(union_5) :- union([1, 2, 3], [3, 4, 5], [1, 2, 3, 4, 5]).
test(union_6) :- union([1, 2], [1, 2], [1, 2]).
...
test(inter_1) :- inter([], [], []).
test(inter_2) :- inter([1], [], []).
test(inter_3) :- inter([], [1], []).
test(inter_4) :- inter([1, 2], [2, 3], [2]).
test(inter_5) :- inter([1, 2, 3], [3, 4, 5], [3]).
test(inter_6) :- inter([1, 2], [1, 2], [1, 2]).
